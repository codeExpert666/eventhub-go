...
6. handler 子包可以依赖 generated OpenAPI model、必要的 dto 子包、service 包、HTTP response/requesterror 工具；service、domain、repository 不依赖 HTTP DTO 或 generated OpenAPI model。
